...
const routes: Routes = [
  ...
  { path: 'upload',  loadChildren: () => import('./views/image-upload/image-upload.module')
    .then(mod => mod.ImageUploadModule), canActivate: [AuthGuard] },
  { path: 'image/edit/:id', loadChildren: () => import('./views/image-edit/image-edit.module')
    .then(mod =>  mod.ImageEditModule), canActivate: [AuthGuard] },
